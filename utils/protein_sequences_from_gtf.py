"""
Script for writing sequences of coding proteins from spliced mRNAs from a gff3 file
	modified from stop_context_seq.py
	output a csv file with #transcript, genename, ProtSeq
...
outfilestring = '%s_Protseqs' % (args.gtfInFilePrefix)
