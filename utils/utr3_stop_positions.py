...
Script for writing sequences of spliced mRNAs from a gff3 file
	...
	output a csv file with #transcript, genename, 'frameZeroStopPosUtr3', 'frameZeroStopPosMRNA',
			  'framePlusOneStopPosUtr3', 'framePlusOneStopPosMRNA',
			  'frameMinusOneStopPosUtr3', 'frameMinusOneStopPosMRNA'
...
outfilestring = '%s_utr3StopPositions' % (args.gtfInFilePrefix)
...
def write_utr_stopcodon_csvfile(ucscIDlist, transcriptdict):
	...
	"""
	t=[]
	headers= ['#transcript', 'genename', 
			  'frameZeroStopPosUtr3', 'frameZeroStopPosMRNA',
			  'framePlusOneStopPosUtr3', 'framePlusOneStopPosMRNA',
			  'frameMinusOneStopPosUtr3', 'frameMinusOneStopPosMRNA']
	t.append(headers)
