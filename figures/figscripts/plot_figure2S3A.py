...
samples = samplelist[0:3]+[samplelist[8]]+samplelist[3:8]
print samples
...
colorList = [black, orange, cyan, orange, red, green, blue, yellow, pink]
lineTypes = ['-', '-', '-', '--', '-', '-', '-', '-', '-']
...
def avggene_riboshift_plot_overlay(alignposition, ribosome_site, experiment, fiveorthreeprime='5', normalizaiton='uneq', threshold ="0"):
	...
	plot_outfile = "%s/figures/Fig2S3A.pdf" % (rootDir)
