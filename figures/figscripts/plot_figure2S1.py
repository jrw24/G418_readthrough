...
def plot_corr(dflist):
	...
	samp_ind = [0,2,6,8,10,12,14,2,16]

	treatList = ['Untr', 'G418_500', 'Genta', 'Parom', 'Neo', 'Tobra', 'Amik', 'G418_2000', 'G418_10min']
	...
	for i in samp_ind:
		...
		g = sns.JointGrid(x='cdsDenstilyRPKMlog2_x', y='cdsDenstilyRPKMlog2_y', data=d, xlim=(0,15), ylim=(0,15))
		...
		figout = "%s/figures/Fig2S1_%s_%s.pdf" % (rootDir, counter, treat)
